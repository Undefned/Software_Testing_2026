...
$(document).ready(function() {
    ...
    var data = {"OkPercent": 93.21329639889197, "KoPercent": 6.786703601108033};
    var dataset = [
        {
            "label" : "FAIL",
            "data" : data.KoPercent,
    ...
    // Creates APDEX table
    createTable($("#apdexTable"), {"supportsControllersDiscrimination": true, "overall": {"data": [0.4660664819944598, 500, 1500, "Total"], "isController": false}, "titles": ["Apdex", "T (Toleration threshold)", "F (Frustration threshold)", "Label"], "items": [{"data": [0.4660664819944598, 500, 1500, "GET / config=3"], "isController": false}]}, function(index, item){
        switch(index){
            case 0:
                item = item.toFixed(3);
                break;
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 722, 49, 6.786703601108033, 595.6232686980607, 521, 1443, 581.0, 612.0, 632.2500000000001, 1086.0299999999993, 7.977900552486188, 1.7997021754143647, 1.2309651243093922], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["GET / config=3", 722, 49, 6.786703601108033, 595.6232686980607, 521, 1443, 581.0, 612.0, 632.2500000000001, 1086.0299999999993, 7.977900552486188, 1.7997021754143647, 1.2309651243093922], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
    ...
    createTable($("#top5ErrorsBySamplerTable"), {"supportsControllersDiscrimination": false, "overall": {"data": ["Total", 722, 49, "The operation lasted too long: It took 621 milliseconds, but should not have lasted longer than 620 milliseconds.", 4, "The operation lasted too long: It took 1,040 milliseconds, but should not have lasted longer than 620 milliseconds.", 3, "The operation lasted too long: It took 626 milliseconds, but should not have lasted longer than 620 milliseconds.", 2, "The operation lasted too long: It took 622 milliseconds, but should not have lasted longer than 620 milliseconds.", 2, "The operation lasted too long: It took 628 milliseconds, but should not have lasted longer than 620 milliseconds.", 2], "isController": false}, "titles": ["Sample", "#Samples", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors"], "items": [{"data": ["GET / config=3", 722, 49, "The operation lasted too long: It took 621 milliseconds, but should not have lasted longer than 620 milliseconds.", 4, "The operation lasted too long: It took 1,040 milliseconds, but should not have lasted longer than 620 milliseconds.", 3, "The operation lasted too long: It took 626 milliseconds, but should not have lasted longer than 620 milliseconds.", 2, "The operation lasted too long: It took 622 milliseconds, but should not have lasted longer than 620 milliseconds.", 2, "The operation lasted too long: It took 628 milliseconds, but should not have lasted longer than 620 milliseconds.", 2], "isController": false}]}, function(index, item){
        return item;
    }, [[0, 0]], 0);
